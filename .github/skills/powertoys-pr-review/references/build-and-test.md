...
**Always include:**
1. **Launch command** — the exact, resolved path to the already-built `PowerToys.exe` in this PR's worktree (e.g. `C:\PowerToys-review-N\x64\Debug\PowerToys.exe`). Do **not** tell the user to rebuild; Step 7 already did.
